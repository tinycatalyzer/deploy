...
gsutil.cmd mb -p catalyzer-wikistack -c STANDARD -l US-EAST1 -b on gs://catalyzer-wikistack-static/
gsutil.cmd iam ch allUsers:objectViewer gs://catalyzer-wikistack-static/
